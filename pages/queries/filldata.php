                      ...
                      <table style="height: 100%; width:100%;" class="table table-sm">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style="width: 172px;">&nbsp;
                               <select class="form-control f50" name="fracArancel" id="fracArancel">
                                ...
                                <label>Nueva Fracc</label>
                                <input type="text" class="form-control f50" onclick="" name="newFracc" id="newFracc" placeholder="Nueva Fraccion Arancelaria">
                          ...
                          <tr>
                            ...
                            <td style="width: 172px;">&nbsp;
                              <input type="text" name="qtya" id="qtya" class="form-control f50" aria-label="Default" >  
                            </td>
                          </tr>
                          <tr>
